...
-- NDefines.NDiplomacy.MAX_CLIENT_STATES = 20
 ...
 NDefines.NGovernment.RECEIVE_SERFS_DEVELOPMENT = 3
...
-- NDefines.NGovernment.RECEIVE_SERFS_DEVELOPMENT = 3 is temporary
-- Remember to change NDefines.NMilitary.SLACKEN_MANPOWER_INCREASE = 1.5 on patch change